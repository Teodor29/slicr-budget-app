    ...
    <div className="flex flex-col gap-6">
        ...
        {incomeEditing ? (
          <div className="flex gap-2 mt-2">
            <input
              ...
              className="flex-1 border border-border rounded-input px-4 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-primary"
              autoFocus
            />
            <button onClick={saveIncome} className="p-2.5 bg-primary text-white rounded-input active:bg-primary-hover">
              <MdCheck className="w-5 h-5" />
            </button>
            <button onClick={() => setIncomeEditing(false)} className="p-2.5 border border-border rounded-input text-muted active:bg-gray-50">
      ...
      <div className="bg-surface rounded-card p-5 shadow-sm">
              ...
              {editingCat?.id === cat.id ? (
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 border border-border rounded-input px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                    autoFocus
                  />
                  <input
                    type="number"
                    ...
                    className="w-28 border border-border rounded-input px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                  />
        ...
        <button
          ...
          className="w-full mt-3 py-3 rounded-input border-2 border-dashed border-border text-sm font-medium text-muted active:bg-gray-50"
        >
          + Add category
        </button>
      </div>
