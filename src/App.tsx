      ...
      <div className="md:hidden flex flex-col min-h-[100dvh]">
        ...
        {showFab && (
          <button
            ...
            className="fixed right-4 z-20 w-14 h-14 rounded-full bg-primary text-white shadow-lg flex items-center justify-center active:bg-primary-hover hover:bg-primary-hover"
